...
- [x] T002 `[TDD]` (US2, D2) `DialogueDismissScript.source` — canonical script removes fixed/sticky, resets overflow/margin, top-level only — NEW `packages/zuraffa_inappwebview/lib/src/dialogue_dismiss.dart`
