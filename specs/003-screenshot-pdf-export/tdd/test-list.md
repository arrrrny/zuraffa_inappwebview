...
|---|---|---|---|
| S1 | `ScreenshotConfiguration` defaults png/100, serializes `{format, quality}`; jpeg/80 overrides; `quality` clamps to 1–100 | T001 | DONE |
...
Counts: 10 behaviors (S6×3 counted per platform), 10 driven red → green, 0 remaining.
