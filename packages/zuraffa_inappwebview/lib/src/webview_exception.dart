...
/// `not_created`, `already_created`, `already_running`, `already_disposed`,
/// `port_not_wired`, `channel_not_wired`, `timeout`, `channel_error`,
/// `malformed_response`, `vcr_unmatched`, `vcr_unsupported_format`,
/// `pool_exhausted`.
