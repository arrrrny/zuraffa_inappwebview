# zuraffa_inappwebview_android

Android adapter for the [zuraffa_inappwebview](https://github.com/arrrrny/zuraffa_inappwebview) federated monorepo:
...
void register() {
  registerAndroidInappwebviewDependencies(
    GetIt.instance,
    channel: AndroidInappwebviewChannel(
