...
void main() {
  group('MacosInappwebviewAdapter', () {
    test('isSupported decodes the native payload', () async {
      final channel = MacosInappwebviewChannel(
        invoke: (_, __) async => {'supported': true},
      );
      final port = MacosInappwebviewPort(channel: channel);
    ...
    test('native error payloads surface as typed failures', () async {
      ...
      await expectLater(
        ...
        throwsA(
          isA<MacosInappwebviewException>()
    ...
    test('without a wired channel registration stays safe and typed',
      ...
      await getIt.reset();
      registerMacosInappwebviewDependencies(getIt);
